...
public class ParallaxTest extends GdxTest {
  ...
  public void create() {
    Texture texture0 = new Texture(Gdx.files.internal("assets/layers2/background_0.png"));
    Texture texture1 = new Texture(Gdx.files.internal("assets/layers2/background_1.png"));
    Texture texture2 = new Texture(Gdx.files.internal("assets/layers2/background_2.png"));
    layers = new TextureRegion[3];
    layers[0] = new TextureRegion(texture0, 0, 0, 288, 180);
